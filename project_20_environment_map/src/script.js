...
// const environmentMap = textureLoader.load('/environmentMaps/blockadesLabsSkybox/cyberpunk_cat_world.png')
...
//         gui.add(skybox, 'radius').min(1).max(200).step(0.01).name('skyboxRadius')
//         gui.add(skybox, 'height').min(1).max(100).step(0.01).name('skyboxHeight')
//     }
// )
